...
#
# uses lasvoxel to modify points within a certain distance of one or many polylines.
...
if sys.argv[c] == "true":
    command.append("-step_z_infinite")
c = c + 1

if sys.argv[c] == "true":
    command.append("-compute_mean_xyz")
c = c + 1

if sys.argv[c] == "true":
    command.append("-empty_voxels")
c = c + 1
