...
#
# uses lasdistance to classifies, flags, or removes LiDAR points based on their
# approximate xy distance from polygonal segments.
#
...
### maybe classify instead of distance
if sys.argv[c] == "true":
    command.append("-classify")
    command.append(sys.argv[c+1].split("=")[0])
c = c + 2
