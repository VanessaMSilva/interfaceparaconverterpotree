...
#
# Transforms LiDAR from one horizontal datum to another using either a NTv2 grid or a seven parameter helmert transformation
#
...
if sys.argv[c] == "true":
    command.append("-set_ogc_wkt")
c = c + 1

if sys.argv[c] == "true":
    command.append("-preserve_z")
c = c + 1
