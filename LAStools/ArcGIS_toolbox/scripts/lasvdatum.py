...
#
# Transforms LiDAR from ellipsoidal to orthometric elevations using a grid in format that is usually provided by the
# national survey and expresses the vertical differences between some geoidal model and some elliptical model of the earth.
#
...
command.append("-vgrid")
command.append(sys.argv[c])
c = c + 1

if sys.argv[c] == "true":
    command.append("-bicubic")
c = c + 1
